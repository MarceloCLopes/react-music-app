import maskGroup23Img from "../assets/maskGroup23.png";
import pathImg from "../assets/path.png";
import group9Img from "../assets/group9.png";

export function MusicPlayer() {
  return (
    <div className="musicPlayer flex flex-col px-5 py-3 w-full border-2 border-black bg-[#232A4E] rounded-xl mt-5">
      {/** Upper Part */}
      <div className="upperPart flex items-center justify-between">
        ...
        <div className="profile flex">
          ...
          <div className="details flex flex-col ml-4">
            <span className="text-base">Trstam Bone Dry</span>
            <span className="text-sm text-gray-500">Unknown Artist</span>
          </div>
        </div>
        <div>
          <img src={pathImg} alt="" className="h-4" />
        </div>
      </div>
      ...
      <div className="lowerPart">
        ...
        <div className="track flex justify-between text-sm text-gray-500 flex-[2] items-center">
          <span>2: 30</span>
          <img src={group9Img} alt="" className="w-64" />
          <span>4: 30</span>
        </div>
